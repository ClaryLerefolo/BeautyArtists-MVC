...
namespace BeautyInRedAndGold.Migrations
{
    ...
    [Migration("20260906174932_AddRecipientCodeToArtistProfile")]
    partial class AddRecipientCodeToArtistProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeautyArtists.Models.ArtistProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("BankAccountVerifiedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("StudioPostalCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StudioProvince")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BeautyArtists.Models.Booking", b =>
                {
                    ...
                    b.Property<decimal>("AdminResolutionAmount")
                    ...
                    b.Property<decimal>("CardProcessingFee")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<DateTime?>("ConfirmationPromptSentAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("FinalPaidDate")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("FinalPaymentPaid")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<DateTime?>("FundsReleasedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("PaymentReminder1SentAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("PaymentReminder2SentAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("PaymentReminder3SentAt")
                        .HasColumnType("datetime2");

                    b.Property<bool>("PaymentWindowOpen")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BeautyArtists.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("BeautyArtists.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BeautyArtists.Models.ApplicationUser", "Sender")
                        .WithMany()
